...
router.post("/createNewEntry", async (req, res) => {
    try {
        const { name, lastName, telnum, people, peopleinfo1, peopleinfo2, peopleinfo3, peopleinfo4, help, helpnot, all,veget,vegan,alerg,spezi, arrival, parkplatz, schlafplatz, things } = req.body;
